...
const microcopy = computed(() => {
    return (props.model.content?.microcopy as string) || 'No spam. Unsubscribe anytime.';
});
...
<template>
    ...
    >
        <div class="pointer-events-none absolute inset-0">
            ...
            <div class="absolute right-10 top-10 h-44 w-44 rounded-full bg-slate-200/25 blur-3xl"></div>
        </div>

        <div class="relative z-10 grid gap-8 md:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] md:items-center">
            <div class="space-y-6">
                <div class="space-y-3">
                    ...
                    <h3 class="text-3xl font-semibold tracking-tight text-gray-900 md:text-4xl">
                        {{ model.title }}
                    </h3>

                    <p v-if="model.shortText" class="max-w-2xl text-base leading-relaxed text-gray-600 md:text-lg">
                        {{ model.shortText }}
                    </p>
                </div>
            ...
            <div class="md:justify-self-end md:w-full md:max-w-md">
                ...
                <div v-else>
                    ...
                    <div v-else class="rounded-2xl bg-gray-50 p-6 ring-1 ring-black/5">
                        <div class="flex items-start justify-between gap-4">
                            <p class="text-sm font-semibold text-gray-900">Where should we send it?</p>
                        ...
                        <form class="mt-4 grid gap-4" @submit.prevent="doSubmit">
                            <div>
